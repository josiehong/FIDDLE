...
# Data preprocessing
# --------------------------
python prepare_msms_all.py --dataset mona --instrument_type qtof --config_path ./msfiddle/config/fiddle_tcn_demo.yml --pkl_dir ./data/demo_cl_pkl/
...
--config_path ./msfiddle/config/fiddle_tcn_demo.yml \
...
--train_data ./data/demo_cl_pkl/qtof_random_train.pkl \
--test_data ./data/demo_cl_pkl/qtof_random_test.pkl \
--config_path ./msfiddle/config/fiddle_tcn_demo_wo_da.yml \
...
--device 4 5
nohup python scripts/train_rescore.py --train_data ./data/demo_cl_pkl/qtof_random_rescore_train.pkl \
...
# FIDDLES (test)
python scripts/run_fiddle.py --test_data ./data/demo_cl_pkl/qtof_random_test.mgf \
--config_path ./msfiddle/config/fiddle_tcn_qtof.yml \
--resume_path ./check_point/fiddle_tcn_demo_qtof_cl.pt \
